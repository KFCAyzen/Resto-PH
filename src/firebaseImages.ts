// URLs Firebase Storage simplifiées sans tokens
...
export const images = {
  adminActif: getImageUrl('icons8-utilisateur-50.png'),
  admin: getImageUrl('icons8-profile-50.png'),
  logOut: getImageUrl('icons8-deconnexion-100.png'),
  cross: getImageUrl('icons8-multiplier-100.png'),
  fanta: getImageUrl('fanta.jpg'),
  reaktor: getImageUrl('reaktor.jpg'),
  trash: getImageUrl('icons8-poubelle-64.png'),
  food: getImageUrl('icons8-bar-alimentaire-50.png'),
  food2: getImageUrl('icons8-food-bar-50.png'),
  search: getImageUrl('icons8-search-50.png'),
  glass: getImageUrl('icons8-verre-a-vin-50.png'),
  glass1: getImageUrl('icons8-verre-a-vin2-50.png'),
  carts: getImageUrl('icons8-shopping-cart-50.png'),
  carts1: getImageUrl('icons8-shopping-cart-50%20(1).png'),
  whatsapp: getImageUrl('icons8-whatsapp-50.png'),
  loc: getImageUrl('icons8-position-50.png'),
  phone: getImageUrl('icons8-telephone-50.png'),
  mail: getImageUrl('icons8-nouveau-message-50.png'),
  ...
  pouletDg: getImageUrl('poulet_DG.jpg'),
  ...
  up: getImageUrl('icons8-fleche-haut-100.png'),
  facebook: getImageUrl('icons8-facebook-100.png'),
  tiktok: getImageUrl('icons8-tiktok-50.png'),
