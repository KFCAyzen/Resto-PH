...
export const images = {
  adminActif: getLocalOrFirebase('/icons8-utilisateur-50.png', 'icons8-utilisateur-50.png'),
  admin: getLocalOrFirebase('/icons8-profile-50.png', 'icons8-profile-50.png'),
  logOut: getLocalOrFirebase('/icons8-déconnexion-100.png', 'icons8-deconnexion-100.png'),
  cross: getLocalOrFirebase('/icons8-multiplier-100.png', 'icons8-multiplier-100.png'),
  fanta: getLocalOrFirebase('/fanta.jpg', 'fanta.jpg'),
  reaktor: getLocalOrFirebase('/reaktor.jpg', 'reaktor.jpg'),
  trash: getLocalOrFirebase('/icons8-poubelle-64.png', 'icons8-poubelle-64.png'),
  food: getLocalOrFirebase('/icons8-bar-alimentaire-50.png', 'icons8-bar-alimentaire-50.png'),
  food2: getLocalOrFirebase('/icons8-food-bar-50.png', 'icons8-food-bar-50.png'),
  search: getLocalOrFirebase('/icons8-search-50.png', 'icons8-search-50.png'),
  glass: getLocalOrFirebase('/icons8-verre-à-vin-50.png', 'icons8-verre-a-vin-50.png'),
  glass1: getLocalOrFirebase('/icons8-verre-à-vin2-50.png', 'icons8-verre-a-vin2-50.png'),
  carts: getLocalOrFirebase('/icons8-shopping-cart-50.png', 'icons8-shopping-cart-50.png'),
  carts1: getLocalOrFirebase('/icons8-shopping-cart-50 (1).png', 'icons8-shopping-cart-50%20(1).png'),
  whatsapp: getLocalOrFirebase('/icons8-whatsapp-50.png', 'icons8-whatsapp-50.png'),
  loc: getLocalOrFirebase('/icons8-position-50.png', 'icons8-position-50.png'),
  phone: getLocalOrFirebase('/icons8-téléphone-50.png', 'icons8-telephone-50.png'),
  mail: getLocalOrFirebase('/icons8-nouveau-message-50.png', 'icons8-nouveau-message-50.png'),
  up: getLocalOrFirebase('/icons8-flèche-haut-100.png', 'icons8-fleche-haut-100.png'),
  facebook: getLocalOrFirebase('/icons8-facebook-100.png', 'icons8-facebook-100.png'),
  ...
  gestionActif: getLocalOrFirebase('/icons8-requirements-50.png', 'icons8-requirements-50.png'),
  gestion: getLocalOrFirebase('/icons8-requirements-50 (1).png', 'icons8-requirements-50%20(1).png'),
  historiqueActif: getLocalOrFirebase('/icons8-passé-100.png', 'icons8-passe-100.png'),
  historique: getLocalOrFirebase('/icons8-passé-100 (1).png', 'icons8-passe-100%20(1).png'),
  commandesActif: getLocalOrFirebase('/icons8-checklist-50.png', 'icons8-checklist-50.png'),
  commandes: getLocalOrFirebase('/icons8-checklist-50 (1).png', 'icons8-checklist-50%20(1).png'),
  backArrow: getLocalOrFirebase('/icons8-arrière-50.png', 'icons8-arriere-50.png')
};